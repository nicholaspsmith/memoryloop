...
import { testGET, testPOST, testPATCH, testDELETE } from '@/tests/helpers/route-test-helper'
...
describe('Deck CRUD API Contract Tests', () => {
  ...
  let mockSession: { user: { id: string; email: string; name: string } }
  ...
  describe('GET /api/decks/{deckId}', () => {
    it('should get deck details with flashcard list', async () => {
      const response = await testGET(deckIdRoutes.GET, `/api/decks/${testDeckId}`, {
  ...
  describe('PATCH /api/decks/{deckId}', () => {
    it('should update deck name', async () => {
      const response = await testPATCH(deckIdRoutes.PATCH, `/api/decks/${testDeckId}`, {
        params: { deckId: testDeckId },
  ...
  describe('POST /api/decks/{deckId}/cards', () => {
    it('should add cards to deck', async () => {
      const response = await testPOST(deckCardsRoutes.POST, `/api/decks/${testDeckId}/cards`, {
        params: { deckId: testDeckId },
        body: {
  ...
  describe('DELETE /api/decks/{deckId}/cards', () => {
    beforeAll(async () => {
      ...
      await testPOST(deckCardsRoutes.POST, `/api/decks/${testDeckId}/cards`, {
        params: { deckId: testDeckId },
        body: {
          flashcardIds: [testFlashcardIds[0], testFlashcardIds[1]],
        },
    ...
    it('should remove cards from deck', async () => {
      const response = await testDELETE(deckCardsRoutes.DELETE, `/api/decks/${testDeckId}/cards`, {
        params: { deckId: testDeckId },
        body: {
          flashcardIds: [testFlashcardIds[0]],
        },
  ...
  describe('DELETE /api/decks/{deckId}', () => {
    it('should delete deck and preserve flashcards', async () => {
      const response = await testDELETE(deckIdRoutes.DELETE, `/api/decks/${testDeckId}`, {
        params: { deckId: testDeckId },
        session: mockSession,
      })
